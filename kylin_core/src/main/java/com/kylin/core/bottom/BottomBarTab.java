...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        // mIcon.setColorFilter(ContextCompat.getColor(context, R.color.darktitle));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.color_999999));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            // mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.color_tab_green));
            mIcon.setSelected(true);
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_tab_green));
        } else {
            //mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_unselect));
            //mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_unselect));
            // mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.darktitle));
