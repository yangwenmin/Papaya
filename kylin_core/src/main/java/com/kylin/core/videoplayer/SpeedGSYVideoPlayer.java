...
public class SpeedGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected LinearLayout speedLl;
     ...
     */
    public SpeedGSYVideoPlayer(Context context, Boolean fullFlag) {
    ...
    public SpeedGSYVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init(Context context) {
        ...
        speedLl = (LinearLayout) findViewById(R.id.ll_speed);
        ...
        // 播放速度
        speedLl.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public int getLayoutId() {
        return R.layout.video_layout_speed;
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, SpeedGSYVideoPlayer.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        SpeedGSYVideoPlayer sf = (SpeedGSYVideoPlayer) from;
        SpeedGSYVideoPlayer st = (SpeedGSYVideoPlayer) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            SpeedGSYVideoPlayer gsyVideoPlayer = (SpeedGSYVideoPlayer) gsyBaseVideoPlayer;
    ...
    protected void hideAllWidget() {
        ...
        // 是否显示播放速度
        setViewShowState(speedLl, INVISIBLE);
    }
    ...
    protected void changeUiToPreparingShow() {
        ...
        // 是否显示播放速度
        setViewShowState(speedLl, VISIBLE);
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(SpeedGSYVideoPlayer speedGSYVideoPlayer) {

        if (mBottomProgressDrawable != null) {
            speedGSYVideoPlayer.setBottomProgressBarDrawable(mBottomProgressDrawable);
        }

        if (mBottomShowProgressDrawable != null && mBottomShowProgressThumbDrawable != null) {
            speedGSYVideoPlayer.setBottomShowProgressBarDrawable(mBottomShowProgressDrawable,
                    mBottomShowProgressThumbDrawable);
        }

        if (mVolumeProgressDrawable != null) {
            speedGSYVideoPlayer.setDialogVolumeProgressBar(mVolumeProgressDrawable);
        }

        if (mDialogProgressBarDrawable != null) {
            speedGSYVideoPlayer.setDialogProgressBar(mDialogProgressBarDrawable);
        }

        if (mDialogProgressHighLightColor != -11 && mDialogProgressNormalColor != -11) {
            speedGSYVideoPlayer.setDialogProgressColor(mDialogProgressHighLightColor, mDialogProgressNormalColor);
        }
    }
